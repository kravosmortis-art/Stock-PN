...
# --- Web Server เพื่อให้ Render เช็ก Health Check ---
...
DEFAULT_ITEMS = [
    ...
    "พานท้ายปืนรีพีทเตอร์", "ปลายกระบอกปืนรีพีทเตอร์", "ลำกล้องลูกซอง", "พวงท้ายลูกซอง", "แบบแปลนดับเบิลบาเรลช็อตกัน",
...
# --- 4. เมนู Dropdown เลือกไอเทม (แก้ไขปัญหาชื่อยาวและการตอบสนอง) ---
...
class ItemSelectView(View):
    def __init__(self, action_type: str):
        ...
        # แยกเป็น Dropdown ละ 25 รายการรองรับไอเทมจำนวนมาก
        chunk_size = 25
